...
<script type="text/javascript">
	$(function() {
		...
		$("#vcodeImg").click(
				function() {
					this.src = "CpachaServlet?method=LoginCpacha&vl=4&fs=28&t="
							+ new Date().getTime();
				});
		...
		$("#submitBtn")
				.click(
						function() {
							if ($("#login-name").val() == "") {
								$.messager.alert("消息提醒", "账户不能为空！", "warning");
								return;
							}
...
<body>
	...
	<div class="header" style="padding: 0;">
		<h2
			style="color: white; width: 400px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;">学生宿舍管理系统</h2>
	</div>
			...
			<form id="form" class="form form-horizontal" method="post">
				<div class="row cl">
					...
					<div class="formControls col-8">
						<input id="login-name" name="account" type="text" placeholder="账户"
				...
				<div class="row cl">
					<div class="formControls col-8 col-offset-3">
						<input id="login-vcode" class="input-text size-L" name="vcode"
							...
							src="CpachaServlet?method=LoginCpacha&vl=4&fs=28">
					</div>
				</div>
	...
	<div class="footer">Copyright &nbsp; SWU @ DormitoryManagement</div>
